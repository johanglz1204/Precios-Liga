              ...
              <div className="w-full overflow-hidden">
                <table className="w-full table-fixed border-collapse text-left text-sm text-slate-600">
                  <thead className="bg-slate-50 border-b border-slate-200 text-xs font-semibold uppercase text-slate-500 tracking-wider">
                    <tr>
                      <th className="px-3 py-3 w-[160px]">Competidor</th>
                      <th className="px-2 py-3 text-right w-[100px]">Último Guardado</th>
                      <th className="px-2 py-3 w-[90px]">Precio ($) *</th>
                      <th className="px-2 py-3 w-[175px]">Quién Capturó *</th>
                      <th className="px-2 py-3 w-[140px]">Tipo de Oferta</th>
                      <th className="px-2 py-3 w-[120px]">Notas</th>
                        ...
                        <tr key={comp.id} className="hover:bg-slate-50/80 transition-colors align-middle">
                          ...
                          <td className="px-4 py-3 font-semibold text-slate-800">
                            <div className="flex items-center space-x-2">
                              <span className="w-3 h-3 rounded-full flex-shrink-0 shadow-sm border border-black/5" style={{ backgroundColor: comp.color }} />
                              <div>
                                <p className="text-slate-900 font-bold leading-tight whitespace-nowrap">{comp.nombre}</p>
                                <p className="text-[9px] text-slate-400 font-normal">{comp.direccion || 'Sin dirección'}</p>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="px-3 py-3 text-right">
                            {guardadoEsteMes ? (
                              <div className="text-[11px] leading-tight">
                                ...
                                <p className="text-[9px] text-slate-400">el {guardadoEsteMes.fecha_captura}</p>
                              </div>
                            ) : (
                              <span className="text-[8px] bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded border border-slate-200/50">
                                Sin captura
                              </span>
                            )}
                          </td>
                          ...
                          <td className="px-3 py-3">
                            <div className="relative rounded-lg shadow-sm">
                              ...
                              <input
                                ...
                                min="0"
                                placeholder="0.00"
                                className="w-full pl-6 pr-2 py-1.5 border border-slate-300 rounded-lg text-xs font-mono text-right focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-white"
                                value={data.precio}
                          ...
                          <td className="px-3 py-3">
                            <div className="relative rounded-lg shadow-sm">
                              ...
                              <select
                                className="w-full pl-7 pr-1 py-1.5 border border-slate-300 rounded-lg text-xs font-medium bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all cursor-pointer"
                                value={data.empleado}
                          ...
                          <td className="px-3 py-3">
                            <div className="relative rounded-lg shadow-sm">
                              <Tag className="absolute left-2 top-2.5 h-3.5 w-3.5 text-slate-400 pointer-events-none" />
                              <input
                                type="text"
                                placeholder="Ej: 3+1, Descto 10%..."
                                className="w-full pl-7 pr-2 py-1.5 border border-slate-300 rounded-lg text-xs font-medium focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all bg-white"
                          ...
                          <td className="px-3 py-3">
                            <div className="relative rounded-lg shadow-sm">
                              <FileText className="absolute left-2 top-2 h-3.5 w-3.5 text-slate-400 pointer-events-none" />
                              <input
                                type="text"
                                placeholder="Observaciones..."
                                className="w-full pl-7 pr-2 py-1.5 border border-slate-300 rounded-lg text-xs font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-white"
                                value={data.notas}
                                onChange={(e) => handleGridChange(comp.id, 'notes' || 'notas', e.target.value)}
                              />
                            </div>
                          </td>
                          ...
                          <td className="px-4 py-3 text-center">
                            <button
                              ...
                              className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold p-2 rounded-lg flex items-center justify-center shadow-sm transition-all hover:shadow hover:scale-[1.05] active:scale-[0.95] mx-auto"
                            >
